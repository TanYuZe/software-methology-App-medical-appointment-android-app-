...
public class Pharmacist_Main extends AppCompatActivity {
    Button PharmaLogin, PharmacistProfile, RetrievePresc;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        PharmaLogin = findViewById(R.id.Pharmacist_Logout);
        ...
        PharmaLogin.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
