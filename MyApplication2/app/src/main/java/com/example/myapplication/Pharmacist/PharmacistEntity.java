...
public class PharmacistEntity
{
    ...
    public void AddPrescription(Long maxID, String drugprescribed, String drugdosage, ArrayList<Prescription> prescriptionArrayList,ArrayList<String>  medlist, Context context)
    {
        ...
        newPrescription.setDrugPrescribed(drugprescribed);
        newPrescription.setDosage(Long.parseLong(drugdosage));
        ...
        for(int i = 0; i < medlist.size(); i++)
        {
            for(int j = 0; j < prescriptionArrayList.size(); j++)
            {
                ...
                {
                    Toast.makeText(context, "Medication already exist. Try again", Toast.LENGTH_LONG).show();
                    break;
                }
                        ...
                        && prescriptionArrayList.get(j).getDosage() != newPrescription.getDosage()  )
                {
                    ...
                    Toast.makeText(context, "Medicine Added!", Toast.LENGTH_LONG).show();
