...
public class Patient_QRcode extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        dataEdt = findViewById(R.id.QRstring_input);
        generateQrBtn = findViewById(R.id.QR_genbtn);
        ...
        generateQrBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (TextUtils.isEmpty(dataEdt.getText().toString())) {
                    ...
                    Toast.makeText(Patient_QRcode.this, "Enter some text to generate QR Code", Toast.LENGTH_SHORT).show();
                } else {
