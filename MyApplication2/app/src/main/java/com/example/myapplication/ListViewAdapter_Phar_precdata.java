...
public class ListViewAdapter_Phar_precdata extends ArrayAdapter<Prescription> {
    ArrayList<Prescription> presc;

    ArrayList<Prescription> array;
    private ListViewAdapter_Phar_precdata.CheckboxCheckListner checkedListner;



    public ListViewAdapter_Phar_precdata(Context context, ArrayList<Prescription> presc) {
    ...
    public View getView(int position, @Nullable View convertview, ViewGroup parent) {
        ...
        if(convertview == null) {
            convertview = LayoutInflater.from(getContext()).inflate(R.layout.listview_phar_prescdata,
                    parent, false);
        }
